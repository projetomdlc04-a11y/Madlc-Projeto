...
export default function CalibracaoApp({ onClose }: Props) {
  ...
  const lookups: Record<string, string[]> = {
    nomeInstrumento: ["Balança Computadora", "Balança Industrial", "Balança de precisão", "Termohigrômetro Digital", "Manômetro Analógico", "Paquímetro Mitutoyo"],
    marca: ["Toledo", "Filizola", "Mettler Toledo", "Shimadzu", "Marte", "Sartorius", "Incotherm", "Mitutoyo"],
